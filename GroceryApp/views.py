...
def shop_grid(request):
    ...
    if product:
        products = Product.objects.raw(f"select * from GroceryApp_product where lower(title) like lower('%%{product}%%') or brand_name like lower('%%{product}%%') or brand_nationality like lower('%%{product}%%')")
    # elif category != "All":
